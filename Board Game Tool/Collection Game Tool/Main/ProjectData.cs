...
namespace Collection_Game_Tool.Main
{
    ...
    class ProjectData
    {
        ...
        [NonSerialized]
        private const string DEFAULT_EXT = ".bggproj";
        [NonSerialized]
        private const string FILTER = "Board Game Generator Project (" + DEFAULT_EXT + ")|*" + DEFAULT_EXT;
        ...
        public void SaveProjectAs(GameSetupModel gsObject, PrizeLevels.PrizeLevels plsObject, DivisionsModel divisionsList)
        {
            ...
            {
                dialog.FileName = "BoardGameGeneratorProject" + DEFAULT_EXT;
            }
            else
            {
